...
public class HealthArticlesActivity extends AppCompatActivity {
    ...
    private String[][] health_details=
            {
                    ...
                    {"Menstural Cramps","","","","Click More Details"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChatbot=findViewById(R.id.buttonHAChatbot);
        ...
        btnChatbot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HealthArticlesActivity.this,HealthChatbotActivity.class));
            }
        });
